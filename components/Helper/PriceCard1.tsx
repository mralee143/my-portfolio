...
const PriceCard1 = ({ bg, plane, price, save }: Props) => {
  return (
    <div className="text-center rounded-lg bg-gray-900">
      ...
      <a
        href="https://mail.google.com/mail/?view=cm&fs=1&to=talhashabbir109@gmail.com&su=Basic%20Package%205%24%20per%20hour&body=Hello,%0A%0A%20I%20am%20interested%20in%20the%20Basic%20Package%20at%205%24%20per%20hour.%0A%0ALooking%20forward%20to%20your%20response.%20%0A%0ABest%20regards"
