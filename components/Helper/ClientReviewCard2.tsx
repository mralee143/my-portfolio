...
const ClientReviewCard2 = ({ image, role, user }: Props) => {
  return (
    <div className="m-2 hover:bg-gray-700 transition-all duration-300 rounded-lg">
      <div className="border-2 p-4 border-gray-700 rounded-xl">
        ...
        <p className="text-[15px] text-white opacity-65 mt-[3rem] text-center">
          Ali Haider did an outstanding job delivering the React and
          Node.js-based dashboard. His UX/UI design skills and attention to
          detail created a seamless, user-friendly interface. His expertise was
...
export default ClientReviewCard2;
