...
const PriceCard3 = ({ bg, plane, price, save }: Props) => {
  return (
    <div className="text-center rounded-lg bg-gray-900">
      ...
      <div className="p-6">
        ...
        <div className="flex items-center space-x-3">
          <CheckIcon className="w-[1.4rem] text-red-500" />
          <p className="text-[17px] text-white opacity-80">Shopify Website</p>
        </div>
      </div>
      <a
        href="https://mail.google.com/mail/?view=cm&fs=1&to=talhashabbir109@gmail.com&su=Premium%20Package%2020%24%20per%20hour&body=Hello,%0A%0A%20I%20am%20interested%20in%20the%20Premium%20Package%20at%2020%24%20per%20hour.%0A%0ALooking%20forward%20to%20your%20response.%20%0A%0ABest%20regards"
